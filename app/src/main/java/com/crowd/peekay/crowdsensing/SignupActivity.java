        ...
        mTextUsername.setOnFocusChangeListener(new View.OnFocusChangeListener() {
            ...
            public void onFocusChange(View view, boolean focused) {
                if (!focused) {
                    ...
                    CheckUsername checkUsername = new CheckUsername(SignupActivity.this, username);
        ...
        mBtnSignup.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (validate()) {
                    ...
                    SignupAsync signup = new SignupAsync(SignupActivity.this, username, email, password);
                    signup.execute();
                }
            }
        });
...
class CheckUsername extends AsyncTask {
    ...
    public CheckUsername(Context context, String username) {
    ...
    protected Object doInBackground(Object[] objects) {
        ...
        String urlString = new UrlString(mContext).getRootUrl() + "user_exist.php";
...
class SignupAsync extends AsyncTask {
    Context mContext;
    String mUsername, mPassword, mEmail;
    ProgressDialog mProgressDialog;
    String mUserMsg;

    public SignupAsync(Context context, String username, String email, String password) {
        this.mContext = context;
        this.mUsername = username;
        this.mEmail = email;
    ...
    protected Object doInBackground(Object[] params) {
        URL url;
        HttpURLConnection connection;
        String urlString = new UrlString(mContext).getRootUrl() + "add_user.php";
